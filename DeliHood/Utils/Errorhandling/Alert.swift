...
enum AlertContext {
    ...
    static let cannotGetPaymentData = AlertItem(title: "Cannot get your payment", description: "We're unable to get details about your order and payment, please try again later.")
}
