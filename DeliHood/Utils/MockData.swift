...
struct MockData {
    ...
    static let order = Order(id: UUID(), items: [OrderItem(id: UUID(), food: MockData.sampleCook.foods.first!, quantity: 2, note: "Testing")], cook: MockData.sampleCook, status: .notOrdered, tip: 10)
}
